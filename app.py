...
df = pd.read_csv(r'C:\Users\gabog\Downloads\Pagina_funcional_bonitaPorfavorFunciona\Pagina_funcional_bonita\my-app\api\df_con_mas.csv')
...
MODEL_PATH = os.path.abspath(r"C:\Users\gabog\Downloads\Pagina_funcional_bonitaPorfavorFunciona\Pagina_funcional_bonita\my-app\api\CodigoRecomendadorFotos\my_model.pt")
